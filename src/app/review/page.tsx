...
//   // ── Valid form
//   return (
//     <div className="min-h-screen flex items-center justify-center p-4 pt-[6rem] pb-[4rem]">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="text" required value={form.name}
                    onChange={(e) => setForm((f) => ({ ...f, name: e.target.value }))}
                    placeholder="John Doe"
                    className="w-full pl-11 pr-4 py-3 bg-white border border-slate-200 rounded-lg text-gray-900 placeholder:text-slate-400 focus:outline-none focus:border-primary/50 transition-colors" />
                </div>
              </div>
