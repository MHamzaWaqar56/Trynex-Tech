...
//               return (
//                 <article key={application._id} className="glass-card p-6 flex flex-col gap-4">
...
//                         </h3>
//                         <p className="text-xs text-gray-900 font-mono truncate">{application.vacancyTitle}</p>
//                       </div>
//                     </div>
//                     <span className={`shrink-0 inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-semibold uppercase tracking-widest border ${status.classes}`}>
//                       {status.label}
//                     </span>
//                   </div>
...
//                       <span className="tag">{application.yearsOfExperience} exp</span>
//                     )}
//                   </div>

//                   {/* Cover letter */}
//                   <div className="glass-card p-4 bg-slate-50/60">
...
//                         View CV{application.cvName ? ` — ${application.cvName}` : ''}
//                       </a>
//                     )}
...
//                     >
//                       <SelectTrigger className="w-full sm:w-[200px] sort-select-trigger">
...
//                       {savingId === application._id ? 'Updating...' : 'Status change notifies applicant via email.'}
//                     </p>
//                   </div>
//                 </article>
//               );
